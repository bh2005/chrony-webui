...
def get_tracking() -> dict:
    if MOCK:
        return {
            "reference_id":    "0A7A0323 (ntp-intern.example.net)",
            "stratum":         2,
...
def get_sources() -> list[dict]:
    if MOCK:
        return [
            {"mode": "^", "state": "*", "name": "192.0.2.35",              "stratum": 1, "poll": 6, "reach": "377", "last_rx": "2",  "last_sample_offset": "-0.123us", "last_sample_err": "+/- 1.2us", "offset": "-123ns"},
            {"mode": "^", "state": "-", "name": "192.0.2.36",              "stratum": 1, "poll": 6, "reach": "377", "last_rx": "3",  "last_sample_offset": "+0.234us", "last_sample_err": "+/- 0.9us", "offset": "+234ns"},
...
def get_config() -> dict:
    if MOCK:
        return {
            "primary":  [{"address": "192.0.2.35", "type": "server", "options": "iburst prefer"},
                         {"address": "192.0.2.36", "type": "server", "options": "iburst prefer"}],
